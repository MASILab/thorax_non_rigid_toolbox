...
def get_metric_list(dice_data_root, surface_data_root):
    metric_list = {
        'Dice_lung' : {
...
def main():
    ...
    parser.add_argument('--surface-data-root', type=str)
    ...
    metric_list = get_metric_list(args.dice_data_root, args.surface_data_root)
