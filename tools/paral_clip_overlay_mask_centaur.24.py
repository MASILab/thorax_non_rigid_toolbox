...
def main():
    ...
    for file_name in file_name_list:
        ...
        out_folder = os.path.join('/nfs/masi/COVID19_public/BIMCV-COVID19/ct_cxr_pair/data/centaur_pilot.24.clip', file_name)
        clip_connected_component_bb_center_with_mask(in_nii, out_nii, out_folder)
