...
##################################################
# 2/18/2020 - Kaiwen
# Run deeds pipeline for label propagation.
# Input:
...
# 3. Register 5 source images to preprocessed target image.
# 4. Propagate 5 label maps using the 5 transformation fields.
# 5. Majority voting for label fusion.
# 6. Resample label map to original image space using reg_resample.
##################################################
...
bash_config_file=${BASH_DIR}/bash_config/deeds_singularity_env.sh
