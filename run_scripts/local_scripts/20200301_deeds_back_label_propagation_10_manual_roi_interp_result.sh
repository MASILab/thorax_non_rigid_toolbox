...
# The input is changed to the interp of affine with manual roi selection.
##################################################
...
source_folder=${DATA_ROOT}/affine_niftyreg_10/interp/full_masked
...
non_rigid_out_root=${DATA_ROOT}/non_rigid_deeds_10_manual_roi_interp_result
