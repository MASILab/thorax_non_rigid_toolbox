...
omat_folder=${OUT_ROOT}/source_image_full_resolution_sparse/omat
reg_folder=${OUT_ROOT}/source_image_full_resolution_sparse/reg
mkdir -p ${omat_folder}
mkdir -p ${reg_folder}

preprocessed_image_folder=${DATA_ROOT}/source_image_full_resolution/preprocess
...
do
  ...
  reg_args="\"-l_5_-G_10x9x8x7x6_-L_10x9x8x7x6_-Q_7x6x5x4x3\""
#  label=${atlas_label}
