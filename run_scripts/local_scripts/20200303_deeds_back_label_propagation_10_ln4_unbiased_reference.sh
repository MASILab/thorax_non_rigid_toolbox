...
###################### Change Log ################
# 3/3/2020 - Kaiwen
# Change the reference to an relative unbiased on.
##################################################
...
reference_img=${DATA_ROOT}/atlas_unbias/atlas.nii.gz
idendity_mat_txt=${DATA_ROOT}/atlas/idendity_matrix.txt
label_img=${DATA_ROOT}/atlas_unbias/label.nii.gz

non_rigid_out_root=${DATA_ROOT}/20200303_01_4_ln_deeds_unbiased/non_rigid
