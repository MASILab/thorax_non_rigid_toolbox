...
omat_folder=${OUT_ROOT}/source_image_full_resolution/omat
reg_folder=${OUT_ROOT}/source_image_full_resolution/reg
mkdir -p ${omat_folder}
mkdir -p ${reg_folder}
...
#  reg_args="\"-l_5_-G_8x7x6x5x4_-L_8x7x6x5x4_-Q_5x4x3x2x1\""
