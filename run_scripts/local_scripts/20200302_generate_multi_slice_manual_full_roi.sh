...
scan_folder=${DATA_ROOT}/affine_niftyreg_10/interp/full_masked
label_folder=${DATA_ROOT}/non_rigid_deeds_10_manual_roi_interp_result/label

out_slice_folder=${DATA_ROOT}/non_rigid_deeds_10_manual_roi_interp_result/multi_scan
