...
target_image_folder=${OUT_ROOT}/target_list/preprocessed_full_resolution

label_map=${OUT_ROOT}/atlas_full_resolution/rib_and_spine.nii.gz
fusion_temp=${OUT_ROOT}/label_fusion_full_resolution
source_image_folder=${OUT_ROOT}/source_image_full_resolution/reg_result
NUM_LABELS=13
