...
IMAGE_ATLAS=${DATA_ROOT}/atlas_1st/atlas.nii.gz
IMAGE_LABEL=${DATA_ROOT}/atlas/rib_and_spine.nii.gz

echo "Atlas image ${IMAGE_ATLAS}"
echo

omat_folder=${OUT_ROOT}/source_image_1st_atlas/omat
reg_folder=${OUT_ROOT}/source_image_1st_atlas/reg
mkdir -p ${omat_folder}
mkdir -p ${reg_folder}
...
do
  ...
  reg_args="\"-l_3_-G_6x5x4_-L_6x5x4_-Q_5x4x3\""
#  label=${atlas_label}
