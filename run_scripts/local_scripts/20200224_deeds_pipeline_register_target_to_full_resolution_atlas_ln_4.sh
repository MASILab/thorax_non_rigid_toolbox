...
omat_folder=${OUT_ROOT}/target_reg_full_resolution_ln_4/omat
reg_folder=${OUT_ROOT}/target_reg_full_resolution_ln_4/reg
mkdir -p ${omat_folder}
mkdir -p ${reg_folder}
...
do
  ...
  reg_args="\"-l_4_-G_9x8x7x6_-L_9x8x7x6_-Q_6x5x4x3_-a_4.0\""
#  label=${atlas_label}
