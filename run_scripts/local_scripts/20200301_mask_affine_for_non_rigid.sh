...
target_data_folder=${DATA_ROOT}/affine_niftyreg_manual_z_roi/affine_niftyreg/interp/ori
output_folder=${DATA_ROOT}/affine_niftyreg_manual_z_roi/affine_niftyreg/interp/masked_std_roi
